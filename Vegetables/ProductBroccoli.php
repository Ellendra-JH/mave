   ...
   <header class="header">
	...
	echo "<script>";
	   ...
	   echo "</script>";
		...
		?>	
	<nav class="navbar-2">
		<a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleVegetables.php" class="sec"> <u> Vegetable section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Broccoli </h3></a>
	</nav>  
			...
			<table>
				<tr>
					...
					<td rowspan = "2" class = "pic" > 
						<img src="../img/broccoli.png" alt = "broccoli" id = "center" />
					</td>
					...
					<td class = "aisle"> <br><br>
						...
						<div class = "prodquantity">
							...
							<select name = "type" id = "typ">
								<option value = "wbroccoli"> Whole broccoli  </option>
							   <option value = "cbroccoli">  Chopped broccoli </option>	
							</select>
							
							<!--product price -->				
							<div class = "price">
								<div style="line-height:75%;"><br></div>
								<div id = "prices" data-value = "4.50">4.50$</div>
							</div>
							...
							<div style="line-height:45%;"><br></div>
								...
								<a id = "moredesc" style = "display:none; position:absolute;"> Nutrient-filled certified Broccolis!</a>
							<div style="line-height:75%;"><br></div>  
						</div>
					</td>
				</tr>
