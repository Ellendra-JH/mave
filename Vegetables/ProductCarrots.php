   ...
   <header class="header">
	...
	echo "<script>";
	   ...
	   echo "</script>";
		...
		?>	
	<nav class="navbar-2">
		<a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleVegetables.php" class="sec"> <u> Vegetable section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Carrots </h3></a>
	</nav>  
			...
			<table>
				<tr>
					...
					<td rowspan = "2" class = "pic" > 
						<img src="../img/carrot.png" alt = "carrot" id = "center" />
					</td>
					...
					<td class = "aisle"> <br><br>
						...
						<div class = "prodquantity">
							...
							<select name = "type" id = "typ">
								<option value = "wcarrots"> Whole carrots  </option>
							   <option value = "bcarrots">  Baby carrots </option>
							   <option value = "scarrots">  Shreded carrots </option>		
							</select>
							
							<!--product price -->				
							<div class = "price">
								<div style="line-height:75%;"><br></div>
								<div id = "prices" data-value = "3.97">3.97$</div>
							</div>
							
							<!--product description-->
							<div style="line-height:45%;"><br></div>
								Removed from the ground yesterday
								<label for="desc"></label>
								<br>
								<input type="button" class = "button" id="desc" name="desc" value = "More description">
								<a id = "moredesc" style = "display:none; position:absolute;"> Naturally grown organic carrots</a>
							<div style="line-height:75%;"><br></div>  
						</div>
					</td>
				</tr>
					...
					<table class = "auxiliarytable">
						<tr>
							<td class = "quantitydesired">
								Quantity desired
								<label for="qty"></label>
								<input class="quantity" id="qty" min="1" max = "25" name="qty" value="1" type="number">
								 
								<!--quantity in stock-->
								<div class = "stock">25 in stock;</div>
							</td>
