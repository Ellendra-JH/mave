...
<html>
   <head>
       ...
       <title> Mave | Product Clorax Disinfecting Wipes </title>
		<meta charset="UTF-8">
...
<nav class="navbar-2">
  <a><h3> <a href="../index.html" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="Aisle Cleaning Supplies.html" class="sec"> <u> Cleaning Supplies Section </u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Clorox Disinfecting Wipes</h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="clorax.png" alt = "Clorox Disinfecting Wipes" id = "center" /></td>
           <!--product image above-->
...
<div id = "prices" data-value = "5.49">    5.49$</div>
    ...
    <br>
               ...
               <h6>"We make everyday life better, everyday."</h6><br>
                <!--description above-->
          ...
          <table class = "auxiliarytable">
            <tr>
              <td class = "quantitydesired">Quantity desired
                <label for="qty"></label>
                <input class="quantity" id="qty" min="1" max = "50" name="qty" value="1" type="number">
                  <!--change max above-->
                <div class = "stock">50 in stock;</div>
