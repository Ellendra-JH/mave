...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleBakedGoods.php" class="sec"> <u> Baked Goods section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Cookie </h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="../img/cookie.png" alt = "cookie" id = "center" /></td>
           <!--product image above-->
...
<option value = "1.5">  15g-</option>
<option value = "2">  20g-</option>
...
<div id = "prices" data-value = "0.99">    0,99$</div>
    ...
    <br>
                ...
                Chocolate Chip Cookie (16g avg.)
                <!--description above-->
                <label for="desc"></label>
                <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More descrpiption">
  <a id = "moredesc" style = "display:none; position:absolute;"> Ultimate Chocolate Chip Cookie!</a>
