...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleBakedGoods.php" class="sec"> <u> Baked Goods section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; White Bread </h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="../img/whitebread.png" alt = "whitebread" id = "center" /></td>
           <!--product image above-->
...
<!--different sizes above-->
    ...
    <br>
                ...
                White Bread (100g avg.)
                <!--description above-->
                <label for="desc"></label>
                <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More description">
  <a id = "moredesc" style = "display:none; position:absolute;"> Traditional white bread!</a>
