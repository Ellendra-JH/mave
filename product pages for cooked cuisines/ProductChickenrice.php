...
<html>
   <head>
		...
		<title> Mave | Product Chicken Rice  </title>
   </head>
			...
			<table>
				<tr>
					...
					<td rowspan = "2" class = "pic" > 
						<img src="img/Chicken rice.png" alt = "carrot" id = "center" />
					</td>
					...
					<td class = "aisle"> <br><br>
						...
						<div class = "prodquantity">
							...
							<div style="line-height:45%;"><br></div> 
								<h3>cooked to serve your taste buds.</h3>
								<label for="desc"></label>
								
								<input type="button" class = "button" id="desc" value = "More description">
								<a id = "moredesc"  style = "display:none; position:absolute;"> Cooked by world-renowned chefs</a>
							<div style="line-height:75%;"><br></div>  
						</div>
					</td>
				</tr>
