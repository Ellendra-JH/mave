...
<html>
   <head>
		...
		<title> Mave | Product Poutine  </title>
   </head>
			...
			<table>
				<tr>
					...
					<td rowspan = "2" class = "pic" > 
						<img src="img/Poutine.png" alt = "carrot" id = "center" />
					</td>
					...
					<td class = "aisle"> <br><br>
						...
						<div class = "prodquantity">
							...
							<select name = "type" id = "typ">
								<option value = "extra-g"> Extra Gravy  </option>
							   <option value = "extra-ch">  Extra Cheese (+1.00$)</option>
							   <option value = "extra-g&ch">  Extra Cheese & Gravy (+1.50$)</option>
							   <option value = "no-g">  NO Cheese </option>
							   <option value = "no-ch">  NO Gravy </option>
							   <option value = "no-g&ch">  NO Cheese & NO Gravy </option>		
							</select>
							
							<!--product price -->				
							<div class = "price">
								<div style="line-height:75%;"><br></div>
								<div id = "prices" data-value = "2.99">2.99$ </div>
							</div>
							
							<!--product description-->
							<div style="line-height:45%;"><br></div> 
								<h3>A Dish That Would Give Your Taste a Magic Taste.</h3>
								<label for="desc"></label>
								
								<input type="button"  class = "button"  id="desc" value = "More description">
								<a id = "moredesc" style = "display:none; position:absolute;"> Warm freshly cooked poutines</a>
							<div style="line-height:75%;"><br></div>  
						</div>
					</td>
				</tr>
