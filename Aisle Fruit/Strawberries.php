...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="../Aisle Fruit/Fruit Aisle.php" class="sec"> <u> Fruits section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Strawberries </h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="img/strawberries.png" alt = "strawberries" id = "center" /></td>
           <!--product image above-->
            <td class = "aisl"> The<br><a href= "AisleFruits.php">
...
<div style="line-height:55%;">
    ...
    <br>
                ...
                <!--description above-->
                <label for="desc"> Organic Strawberries </label>
                 <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More description"> 
  <a id = "moredesc" style = "display:none; position:absolute;"> Fresh, organic and handpicked strawberries!</a>
          ...
          <table class = "auxiliarytable">
            <tr>
              <td class = "quantitydesired">Quantity desired
                <label for="qty"></label>
                <input class="quantity" id="qty" min="1" max = "23" name="qty" value="1" type="number">
                  <!--change max above-->
                <div class = "stock">23 in stock;</div>
