...
<nav class="navbar-2">
  <a><h3> <a href="../index..php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="../Aisle Fruit/Fruit Aisle..php" class="sec"> <u> Fruits section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Apple </h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="img/apple.png" alt = "apple" id = "center" /></td>
           <!--product image above-->
            <td class = "aisl"> The<br><a href= "../Aisle Fruit/Fruit Aisle..php">
              <span style = "background-color:white ;color:black;">Fruits section </span></a>
...
<div style="line-height:55%;">
  ...
  <br>
    ...
    <option value = "honeycrisp"> Honey Crisp </option>
   <option value = "grannysmith">  Granny Smith </option>
   <option value = "goldendelicious">  Golden Delicious </option>
  <!--different types abovee-->
    ...
    <br>
               ...
               <div id = "prices" data-value="1.40">   1,40$</div>
    ...
    <br>
                ...
                Nutrient-filled apple 
                <!--description above-->
                <label for="desc"></label>
                <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More description">
  <a id = "moredesc" style = "display:none; position:absolute;"> Naturally grown and 100% organic apples from our finest farms</a>
          ...
          <table class = "auxiliarytable">
            <tr>
              <td class = "quantitydesired">Quantity desired
                <label for="qty"></label>
                <input class="quantity" id="qty" min="1" max = "53" name="qty" value="1" type="number">
                  <!--change max above-->
                <div class = "stock">53 in stock;</div>
