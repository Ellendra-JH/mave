...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="../Aisle Fruit/Fruit Aisle.php" class="sec"> <u> Fruits section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Banana </h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="img/banana.png" alt = "banana" id = "center" /></td>
           <!--product image above-->
...
<div style="line-height:55%;">
    ...
    <br>
              ...
              <div id = "prices" data-value = "0.62">0.62$</div>
  ...
  <a id = "moredesc" style = "display:none; position:absolute;"> Sweet and fiber-rich banana!</a>
          ...
          <table class = "auxiliarytable">
            <tr>
              <td class = "quantitydesired">Quantity desired
                <label for="qty"></label>
                <input class="quantity" id="qty" min="1" max = "32" name="qty" value="1" type="number">
                  <!--change max above-->
                <div class = "stock">32 in stock;</div>
