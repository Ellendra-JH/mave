...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleMeats.php" class="sec"> <u> Meat section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Raw Beef</h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="../img/beef.jpg" alt = "cold cuts" id = "center" /></td>
           <!--product image above-->
  ...
  <!--different sizes above-->
    ...
    <option value = "tradit"> Traditional beef  </option>
   <option value = "bnlss">  Premium beef (+0.50$)</option>
   <option value = "bnlssPRM">  Premium seasoned beef(+0.99$)</option>
  <!--different types abovee-->
    ...
    <br>
              ...
              <div id = "prices" data-value="9.99"> 9,99$</div> 
    ...
    <br>
                ...
                Delicious beef to be cooked
                <!--description above-->
                <label for="desc"></label>
                <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More description">
  <a id = "moredesc" style = "display:none; position:absolute;"> The best imports </a>
