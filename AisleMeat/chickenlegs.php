...
<nav class="navbar-2">
  <a><h3> <a href="../index.php" class="sec"> <u>Home</u> &nbsp;&nbsp;  / </a> &nbsp;&nbsp; <a href="AisleMeats.php" class="sec"> <u> Meat section</u>&nbsp;&nbsp; / </a>&nbsp;&nbsp; Chicken legs</h3></a>
</nav>
...
<div class = "wrapping">
      ...
      <table>
         <tr >
            <td rowspan = "2" class = "pic" > <img src="../img/chickenlegs.jpg" alt = "chicken legs" id = "center" /></td>
           <!--product image above-->
  ...
  <!--different sizes above-->
    ...
    <option value = "tradit"> Traditional legs  </option>
   <option value = "bnlss">  Boneless legs </option>
   <option value = "bnlssPRM">  Premium boneless </option>
  <!--different types abovee-->
    ...
    <br>
              ...
              <div id = "prices" data-value="3.99">    3,99$ </div>
    ...
    <br>
                ...
                Finest chicken legs cut
                <!--description above-->
                <label for="desc"></label>
                <br>
  <input type="button" class = "button" id="desc" name="desc" value = "More description">
  <a id = "moredesc" style = "display:none; position:absolute;"> Naturally grown </a>
          ...
          <table class = "auxiliarytable">
            <tr>
              <td class = "quantitydesired">Quantity desired
                <label for="qty"></label>
                <input class="quantity" id="qty" min="1" max = "12" name="qty" value="1" type="number">
                  <!--change max above-->
                <div class = "stock">12 in stock;</div>
